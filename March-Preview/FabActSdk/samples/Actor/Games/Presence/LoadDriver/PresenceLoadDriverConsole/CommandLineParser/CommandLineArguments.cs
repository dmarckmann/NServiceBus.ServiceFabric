...
public class CommandLineArgumentParser
{
    ...
    public string Usage
    {
        get
        {
            ...
            if (this.defaultArgument != null)
            {
                AppendArgumentUsage(builder, this.defaultArgument, oldLength, true);
            }

            foreach (Argument arg in this.arguments)
            {
                oldLength = builder.Length;
                AppendArgumentUsage(builder, arg, oldLength, false);
            }
    ...
    private static string Description(CommandLineArgumentAttribute attribute, FieldInfo field)
    {
    ...
    private class Argument
    {
        public Argument(CommandLineArgumentAttribute attribute, FieldInfo field, ErrorReporter reporter)
        {
            ...
            this.description = CommandLineArgumentParser.Description(attribute, field);
